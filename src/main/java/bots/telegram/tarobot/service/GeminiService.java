...
public class GeminiService {
    ...
    public String getResponse(HashMap<Integer, TarotCard> cards, String mergedData){
        ...
        String prompt = ("Привет, ты - потомственная гадалка Инга. Ты гадаешь на Таро Уэйта и делаешь расклад по методике (Три Карты). " +
                "То есть, первая - прошлое, вторая - настоящее, третья - будущее. " +
